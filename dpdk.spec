...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656177360
...
"-Ddisable_drivers=net/mvpp2,net/mvneta,crypto/mvsam"  builddir
ninja -v -C builddir
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/-glue/librte_common_mlx5_glue.so
/usr/lib64/-glue/librte_common_mlx5_glue.so.22.0
/usr/lib64/-glue/librte_net_mlx4_glue.so
/usr/lib64/-glue/librte_net_mlx4_glue.so.22.0
