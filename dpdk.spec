...
Source0  : https://fast.dpdk.org/rel/dpdk-20.11.5.tar.xz
...
%prep
%setup -q -n dpdk-stable-20.11.5
cd %{_builddir}/dpdk-stable-20.11.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649133417
...
cp %{_builddir}/dpdk-stable-20.11.5/license/bsd-2-clause.txt %{buildroot}/usr/share/package-licenses/dpdk/bcc67a9a7d4e27cf65e425f5077e250ee239ece6
cp %{_builddir}/dpdk-stable-20.11.5/license/bsd-3-clause.txt %{buildroot}/usr/share/package-licenses/dpdk/7d9185af9b499d91e113fe752af7d9d53b9e5c6a
cp %{_builddir}/dpdk-stable-20.11.5/license/gpl-2.0.txt %{buildroot}/usr/share/package-licenses/dpdk/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/dpdk-stable-20.11.5/license/isc.txt %{buildroot}/usr/share/package-licenses/dpdk/1a68b9d79f4cca4b3ed1d191dbc068bc26fc918e
cp %{_builddir}/dpdk-stable-20.11.5/license/lgpl-2.1.txt %{buildroot}/usr/share/package-licenses/dpdk/3704f4680301a60004b20f94e0b5b8c7ff1484a9
cp %{_builddir}/dpdk-stable-20.11.5/license/mit.txt %{buildroot}/usr/share/package-licenses/dpdk/b1c8d10e65cc798970152f8f037c23a521f8205d
