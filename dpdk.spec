...
Version  : 19.11.5
Release  : 53
URL      : https://fast.dpdk.org/rel/dpdk-19.11.5.tar.xz
Source0  : https://fast.dpdk.org/rel/dpdk-19.11.5.tar.xz
...
%prep
%setup -q -n dpdk-stable-19.11.5
cd %{_builddir}/dpdk-stable-19.11.5
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601509417
