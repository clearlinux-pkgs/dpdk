...
Version  : 20.11.2
Release  : 56
URL      : https://fast.dpdk.org/rel/dpdk-20.11.2.tar.xz
Source0  : https://fast.dpdk.org/rel/dpdk-20.11.2.tar.xz
...
%prep
%setup -q -n dpdk-stable-20.11.2
cd %{_builddir}/dpdk-stable-20.11.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626108887
