...
Version  : 20.11.1
Release  : 55
URL      : https://fast.dpdk.org/rel/dpdk-20.11.1.tar.xz
Source0  : https://fast.dpdk.org/rel/dpdk-20.11.1.tar.xz
...
%prep
%setup -q -n dpdk-stable-20.11.1
cd %{_builddir}/dpdk-stable-20.11.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616008199
