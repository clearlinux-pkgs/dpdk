...
Version  : 19.11
Release  : 51
URL      : http://fast.dpdk.org/rel/dpdk-19.11.tar.xz
Source0  : http://fast.dpdk.org/rel/dpdk-19.11.tar.xz
...
%prep
%setup -q -n dpdk-19.11
cd %{_builddir}/dpdk-19.11
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581355211
